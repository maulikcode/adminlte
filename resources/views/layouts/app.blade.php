...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block {{ (request()->segment(1) == 'home') ? 'active' : '' }}">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <img src="dist/img/user1-128x128.jpg" alt="Img" class="img-size-50 mr-3 img-circle">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('home') }}" class="brand-link">
      <img src="dist/img/AdminLTELogo.png" alt="Laravel" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="{{ route('user.show',['user'=>Auth::user()->id]) }}" class="d-block">{{ ucfirst(Auth::user()->name) }}</a>
        </div>
      </div>
